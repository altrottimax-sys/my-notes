...
Tools have more specific applications than skills. The [History](/3-Mechanics/CLI/skills.md#History) skill applies to any event in the past. A tool such as a [forgery kit](/3-Mechanics/CLI/items/forgery-kit.md) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
In addition, consider giving characters who have both a relevant skill and a relevant tool proficiency an added benefit on a successful check. This benefit might be in the form of more detailed information or could simulate the effect of a different sort of successful check. For example, a character proficient with [mason's tools](/3-Mechanics/CLI/items/masons-tools.md) makes a successful Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) check to find a secret door in a stone wall. Not only does the character notice the door's presence, but you decide that the tool proficiency entitles the character to an automatic success on an Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check to determine how to open the door.
...
Proficiency with [alchemist's supplies](/3-Mechanics/CLI/items/alchemists-supplies.md) allows you to unlock more information on [Arcana](/3-Mechanics/CLI/skills.md#Arcana) checks involving potions and similar materials.
...
Proficiency with [brewer's supplies](/3-Mechanics/CLI/items/brewers-supplies.md) gives you additional insight on Intelligence ([History](/3-Mechanics/CLI/skills.md#History)) checks concerning events that involve alcohol as a significant element.
...
As part of a long rest, you can repair your companions' shoes. For the next 24 hours, up to six creatures of your choice who wear shoes you worked on can travel up to 10 hours a day without making saving throws to avoid [exhaustion](/3-Mechanics/CLI/conditions.md#Exhaustion).

#### Craft Hidden Compartment

With 8 hours of work, you can add a hidden compartment to a pair of shoes. The compartment can hold an object up to 3 inches long and 1 inch wide and deep. You make an Intelligence check using your tool proficiency to determine the Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check DC needed to find the compartment.
...
A [forgery kit](/3-Mechanics/CLI/items/forgery-kit.md) can be used in conjunction with the [Arcana](/3-Mechanics/CLI/skills.md#Arcana) skill to determine if a magic item is real or fake.
...
As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](/3-Mechanics/CLI/items/forgery-kit.md) determines the DC for someone else's Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check to spot the fake.
...
Proficiency with [jeweler's tools](/3-Mechanics/CLI/items/jewelers-tools.md) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](/3-Mechanics/CLI/skills.md#Arcana) checks related to gems or gem-encrusted items.
...
Your knowledge of poisons has taught you to handle those substances carefully, giving you an edge when you inspect [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) objects or try to extract clues from events that involve poison.
...
| Activity | DC |
|----------|----|
| Spot a [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) object | 10 |
