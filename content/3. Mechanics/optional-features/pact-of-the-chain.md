...
Additionally, when you take the [Attack](/3-Mechanics/CLI/actions.md#Attack) action, you can forgo one of your own attacks to allow your familiar to use its reaction to make one attack of its own.