...
| 17th | [commune with nature](/3-Mechanics/CLI/spells/commune-with-nature.md), [tree stride](/3-Mechanics/CLI/spells/tree-stride.md) |
^oath-of-the-ancients-spells
...
You can use your Channel Divinity to invoke primeval forces to ensnare a foe. As an action, you can cause spectral vines to spring up and reach for a creature within 10 feet of you that you can see. The creature must succeed on a Strength or Dexterity saving throw (its choice) or be [restrained](/3-Mechanics/CLI/conditions.md#Restrained). While [restrained](/3-Mechanics/CLI/conditions.md#Restrained) by the vines, the creature repeats the saving throw at the end of each of its turns. On a success, it frees itself and the vines vanish.
