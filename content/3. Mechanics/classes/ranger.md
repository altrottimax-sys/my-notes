...
*1st-level ranger [optional feature](/3-Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Favored Enemy feature and works with the Foe Slayer feature*
...
*1st-level ranger [optional feature](/3-Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Natural Explorer feature*
...
*2nd-level ranger [optional feature](/3-Mechanics/CLI/variant-rules/optional-class-features-tce.md)*
...
*3rd-level ranger [optional feature](/3-Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Primeval Awareness feature*
...
*4th-level ranger [optional feature](/3-Mechanics/CLI/variant-rules/optional-class-features-tce.md)*
...
*10th-level ranger [optional feature](/3-Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Hide in Plain Sight feature*
