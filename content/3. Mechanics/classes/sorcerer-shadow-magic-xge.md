...
When you reach 3rd level in this class, you learn the [darkness](/3-Mechanics/CLI/spells/darkness.md) spell, which doesn't count against your number of sorcerer spells known. In addition, you can cast it by spending 2 sorcery points or by expending a spell slot. If you cast it with sorcery points, you can see through the [darkness](/3-Mechanics/CLI/spells/darkness.md) created by the spell.
