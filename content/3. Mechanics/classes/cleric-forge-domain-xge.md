...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [identify](/3-Mechanics/CLI/spells/identify.md), [searing smite](/3-Mechanics/CLI/spells/searing-smite.md) |
| 3rd | [heat metal](/3-Mechanics/CLI/spells/heat-metal.md), [magic weapon](/3-Mechanics/CLI/spells/magic-weapon.md) |
| 5th | [elemental weapon](/3-Mechanics/CLI/spells/elemental-weapon.md), [protection from energy](/3-Mechanics/CLI/spells/protection-from-energy.md) |
| 7th | [fabricate](/3-Mechanics/CLI/spells/fabricate.md), [wall of fire](/3-Mechanics/CLI/spells/wall-of-fire.md) |
| 9th | [animate objects](/3-Mechanics/CLI/spells/animate-objects.md), [creation](/3-Mechanics/CLI/spells/creation.md) |
^forge-domain-spells

### Bonus Proficiency (Level 1)

When you choose this domain at 1st level, you gain proficiency with heavy armor and [smith's tools](/3-Mechanics/CLI/items/smiths-tools.md).
