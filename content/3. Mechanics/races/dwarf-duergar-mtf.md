...
You have advantage on saving throws against poison, and you have resistance against poison damage. You also have advantage on saving throws against illusions and against being [charmed](/3-Mechanics/CLI/conditions.md#Charmed) or [paralyzed](/3-Mechanics/CLI/conditions.md#Paralyzed).
...
You have disadvantage on attack rolls and Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception)) checks that rely on sight when you, the target of your attack, or whatever you are trying to perceive is in direct sunlight.
