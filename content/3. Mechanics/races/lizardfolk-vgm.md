...
As part of a short rest, you can harvest bone and hide from a slain beast, construct, dragon, monstrosity, or plant creature of size small or larger to create one of the following items: a [shield](/3-Mechanics/CLI/items/shield.md), a [club](/3-Mechanics/CLI/items/club.md), a [javelin](/3-Mechanics/CLI/items/javelin.md), or `1d4` [darts](/3-Mechanics/CLI/items/dart.md) or [blowgun needles](/3-Mechanics/CLI/items/blowgun-needle.md). To use this trait, you need a blade, such as a [dagger](/3-Mechanics/CLI/items/dagger.md), or appropriate artisan's tools, such as [leatherworker's tools](/3-Mechanics/CLI/items/leatherworkers-tools.md).
