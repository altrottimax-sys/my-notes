...
<div style="float: left; margin: 2px; padding-left: 10px; padding-right: 10px; border: 4px solid green; background: #c9bfaa">
  <img src="Z_Assets/Girlies/Petitearena.jpeg" style="border: 2px solid green;"alt="Zaenerys"  height="420" >
  <h6><center>Petitearena Genesis</center></h6>
</div>
