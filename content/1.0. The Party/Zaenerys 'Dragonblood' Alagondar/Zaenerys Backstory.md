...
<div style="float: right; margin: 2px; padding-left: 10px; padding-right: 10px; border: 4px solid purple; background: #c9bfaa">
  <img src="Z_Assets/Girlies/Zaenaerys.jpeg" style="border: 2px solid purple;"alt="Zaenerys"  height="420" >
  <h6><center>Zaenerys Alagondar</center></h6>
</div>
