---
title: "Deliver Goods to the Loggers' Camp"
draft: false
tags:
  -
---
...
<div class="quest-meta">
  ...
  <div class="meta-cell"><span class="m-label">Started</span><span class="m-value">Session 2</span></div>
</div>
...
<ul class="quest-objectives">
  <li><input type="checkbox" checked>Collect the ox and cart and make your way with the cargo to the Logger's Camp</li>
  <li class="failed"><input type="checkbox" > <span>Find the Loggers at their camp</span></li>
  <li><input type="checkbox" checked> Find Tibor Westor and save him from the Ankhegs</li>
  <li><input type="checkbox" checked> Deliver Tibor Westor back to his brother in Phandalin</li>
</ul>

---

> [!success]+ ***Quest Outcome***
> Unfortunately you could not save the rest of the loggers; however, you were able to return Tibor Wester to his brother in Phandalin, fighting off the Ankhegs. An Anchorite of Talos was also discovered and killed... what could they be doing so deep in the Neverwinter Woods?
