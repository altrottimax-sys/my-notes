---
title: "Atttack the Woodland Manse"
draft: false
tags:
  -
---
...
<div class="quest-plate">
  <div class="qp-title">
    <h1>Attack the Woodland Manse</h1>
    <div class="qp-sub">At Falcon's request</div>
  </div>
...
<div class="quest-meta">
  <div class="meta-cell"><span class="m-label">Quest Giver</span><span class="m-value">Falcon</span></div>
  <div class="meta-cell"><span class="m-label">Location</span><span class="m-value">Falcon's Hunting Lodge</span></div>
  <div class="meta-cell"><span class="m-label">Started</span><span class="m-value">Session 7</span></div>
</div>
...
The orcs have fallen under the sway of evil spellcasters in Neverwinter Wood and have been sighted in growing numbers near Falcon's Hunting Lodge. The spellcasters dwell in a ruined manse. Falcon needs someone to make a pre-emptive strike against it. Destroy the evil in the manse, then expect him to reward you.
</div>

## Objectives

<ul class="quest-objectives">
  <li><input type="checkbox" checked>  Discover the location of the Woodland Manse </li>
  <li><input type="checkbox"> Begin your attack </li>
